...
const char* OPTIONS_wcs_rd2xy = "hi:o:w:f:R:D:te:r:d:Lv";

void print_help_wcs_rd2xy(char* progname) {
...
int main_wcs_rd2xy(int argc, char** args) {
    int c;
    char* rdlsfn = NULL;
    char* wcsfn = NULL;
    char* xylsfn = NULL;
    ...
    while ((c = getopt(argc, args, OPTIONS_wcs_rd2xy)) != -1) {
        switch (c) {
        case 'v':
            loglvl++;
            break;
