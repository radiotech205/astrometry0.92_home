...
const char* OPTIONS_wcs_xy2rd = "hi:o:w:f:R:D:te:x:y:X:Y:LTvs";

void print_help_wcs_xy2rd(char* progname) {
...
int main_wcs_xy2rd(int argc, char** args) {
    int c;
    char* rdlsfn = NULL;
    char* wcsfn = NULL;
    char* xylsfn = NULL;
    ...
    while ((c = getopt(argc, args, OPTIONS_wcs_xy2rd)) != -1) {
        switch (c) {
        case 'v':
            loglvl++;
            break;
