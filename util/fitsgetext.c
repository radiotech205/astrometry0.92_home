...
char* OPTIONS_fitsgetext = "he:i:o:baDHMv";

void printHelp_fitsgetext(char* progname) {
...
int main_fitsgetext(int argc, char *argv[]) {
    int argchar;
    ...
    while ((argchar = getopt (argc, argv, OPTIONS_fitsgetext)) != -1)
        switch (argchar) {
        case 'v':
            loglvl++;
            break;
