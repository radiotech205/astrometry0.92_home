...
const char* OPTIONS_wcsinfo = "he:W:H:";

void printHelp_wcsinfo(char* progname) {
...
int main_wcsinfo(int argc, char** args) {
    int argchar;
    ...
    while ((argchar = getopt (argc, args, OPTIONS_wcsinfo)) != -1) {
        switch (argchar) {
        case 'e':
            ext = atoi(optarg);
            break;
