...
static const char* OPTIONS_dstnthing = "hx:m:r:vj:p:i:J:o:W:w:s:X:Y:";

void print_help_dstnthing(char* progname) {
...
int main_dstnthing(int argc, char** args) {
    int c;
    ...
    while ((c = getopt(argc, args, OPTIONS_dstnthing)) != -1) {
        switch (c) {
