...
static const char* OPTIONS_unpermute_stars = "hs:q:S:Q:wcv";

void printHelp_unpermute_stars(char* progname) {
...
int main_unpermute_stars(int argc, char **args) {
    int argchar;
    ...
    while ((argchar = getopt (argc, args, OPTIONS_unpermute_stars)) != -1)
        switch (argchar) {
        case 'c':
            check = TRUE;
            break;
        ...
        case 'h':
            printHelp_unpermute_stars(progname);
            return 0;
        default:
            return -1;
        }
