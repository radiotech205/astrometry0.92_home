...
static const char* OPTIONS_new_wcs = "hi:w:o:de:v";

static void printHelp_new_wcs(char* progname) {
...
int main_new_wcs(int argc, char *argv[]) {
    int argchar;
    char* infn = NULL;
    char* outfn = NULL;
    char* wcsfn = NULL;
    ...
    while ((argchar = getopt (argc, argv, OPTIONS_new_wcs)) != -1)
        switch (argchar) {
        case 'v':
            loglvl++;
            break;
