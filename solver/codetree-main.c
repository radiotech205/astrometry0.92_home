...
static const char* OPTIONS_codetree = "hR:i:o:bsSt:d:";

static void printHelp_codetree(char* progname) {
...
int main_codetree(int argc, char *argv[]) {
    int argidx, argchar;
    ...
    while ((argchar = getopt (argc, argv, OPTIONS_codetree)) != -1)
        switch (argchar) {
        case 'R':
