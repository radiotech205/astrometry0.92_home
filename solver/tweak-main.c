...
static const char* OPTIONS_tweak = "hx:w:r:vj:I:";

void print_help_tweak(char* progname) {
...
int main_tweak(int argc, char** args) {
    int c;
    char* xylsfn = NULL;
    char* wcsfn = NULL;
    char* rdlsfn = NULL;
    ...
    while ((c = getopt(argc, args, OPTIONS_tweak)) != -1) {
        switch (c) {
        case 'I':
            bgfn = optarg;
            break;
