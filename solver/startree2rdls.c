...
static const char* OPTIONS_startree2rdls = "hr:";


void print_help_startree2rdls(char* progname)
{
...
int main_startree2rdls(int argc, char** args) {
    int argchar;
    char* outfn = NULL;
    char* fn;
    rdlist_t* rdls;
    ...
    while ((argchar = getopt (argc, args, OPTIONS_startree2rdls)) != -1)
        switch (argchar) {
        case 'v':
            loglvl++;
            break;
        case 'r':
            ...
            break;
        case 'h':
            print_help_startree2rdls(args[0]);
            exit(0);
        }
