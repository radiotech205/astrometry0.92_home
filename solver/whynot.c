...
static const char* OPTIONS_whynot = "hx:w:i:vj:X:Y:Q:s:O:";

void print_help_whynot(char* progname) {
...
int main_whynot(int argc, char** args) {
    int c;
    char* xylsfn = NULL;
    char* wcsfn = NULL;
    ...
    while ((c = getopt(argc, args, OPTIONS_whynot)) != -1) {
        switch (c) {
        case 's':
